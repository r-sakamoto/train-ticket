...
docker exec -it train-ticket-ts-assurance-mysql-1 mysql -proot -e 'SET GLOBAL default_storage_engine = InnoDB;'
...
docker exec -it train-ticket-ts-station-food-mysql-1 mysql -proot -e 'SET GLOBAL default_storage_engine = InnoDB;'
